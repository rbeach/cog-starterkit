    ...
    $.each(
      ...
      function (mapId, commonMapSettings) {
        ...
        if (typeof geolocationMap.googleMap !== 'undefined') {
          if (mapWrapper.data('centre-lat') && mapWrapper.data('centre-lng')) {
            ...
            if (!geolocationMap.googleMap.getBounds().equals(newBounds)) {
              ...
              var zoom = geolocationMap.googleMap.getZoom();
              geolocationMap.googleMap.setZoom(zoom > 8 ? 8 : zoom);
            }
          }
        }
        ...
        mapWrapper.find('.geolocation-common-map-locations .geolocation').each(function (key, location) {
          ...
          if (mapWrapper[0].classList.contains('doc-finder-map')){
            var docFinderMarker = true;
          }
          ...
          var markerConfig = {
            ...
            docFinderMarker: docFinderMarker,
            numberLabel: location.data('markerLabel') ? location.data('markerLabel').toString(): null,
          };
          ...
          if (typeof location.data('markerLabel') !== 'undefined') {
            markerConfig.label = {
              text: location.data('markerLabel').toString(),
              color: "white",
              fontSize: "15px",
            };
          }
          ...
          var marker = Drupal.geolocation.setMapMarkerSpider(geolocationMap, markerConfig, skipInfoWindow);
